...
import com.cafeom.adapters.PartnerOrderAdapterHC;
import com.cafeom.data.PartnerOrderData;
import com.cafeom.databinding.FragmentFrPartnersOrdersHcBinding;

public class FrPartnersOrdersHC extends FragmentGoodsOrder {

    private FragmentFrPartnersOrdersHcBinding bind;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        bind = FragmentFrPartnersOrdersHcBinding.inflate(getLayoutInflater(), container, false);
        bind.back.setOnClickListener(this);
        bind.rv.setLayoutManager(new LinearLayoutManager(getContext()));
        bind.rv.setAdapter(new PartnerOrderAdapterHC());
        return bind.getRoot();
    }
